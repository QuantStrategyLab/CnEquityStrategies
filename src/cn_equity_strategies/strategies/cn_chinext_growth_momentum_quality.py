...
PROFILE_NAME = "cn_chinext_growth_momentum_quality"
...
DEFAULT_TARGET_ANNUAL_VOLATILITY = 0.20
...
def compute_signals(market_history: Any, _current_holdings: Any = None, **kwargs: Any):
    ...
    signal_desc = (
        f"cn chinext growth momentum quality state={metadata['signal_state']} selected={selected} "
